...
class Iface(object):
    def registerClient(self, Person):
        """
        Parameters:
         - Person
        """
...
class Client(Iface):
    ...
    def registerClient(self, Person):
        ...
        Parameters:
         - Person
        """
        self.send_registerClient(Person)
        return self.recv_registerClient()

    def send_registerClient(self, Person):
...
class Processor(Iface, TProcessor):
    ...
    def process_registerClient(self, seqid, iprot, oprot):
        ...
        result = registerClient_result()
        try:
            result.success = self._handler.registerClient(args.Person)
